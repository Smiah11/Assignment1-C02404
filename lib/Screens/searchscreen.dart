...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _performSearch(String searchTerm) async {
    ...
    TMDB tmdb = TMDB(ApiKeys('721a00709b006f3718730986b3842949', 'eyJhdWQiOiI3MjFhMDA3MDliMDA2ZjM3MTg3MzA5ODZiMzg0Mjk0OSIsInN1YiI6IjY0MTMyMjJkZWRlMWIwMjhlODRlMGQzZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ'));
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => Description(
              name: title,
              bannerurl: 'https://image.tmdb.org/t/p/w500${result['backdrop_path']}',
