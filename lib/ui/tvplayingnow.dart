...
class TvShowsPlaying extends StatelessWidget {
  ...
  const TvShowsPlaying({Key? key, required this.playingnowtv}) : super(key: key);
          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                           Navigator.push(context,MaterialPageRoute(builder: (context)=>Description(name: playingnowtv[index]['original_name'],
                    bannerurl:'https://image.tmdb.org/t/p/w500/'+playingnowtv[index]['backdrop_path'],
                    posterurl: 'https://image.tmdb.org/t/p/w500/'+playingnowtv[index]['poster_path'] ,
