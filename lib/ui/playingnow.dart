          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context)=>Description(name: playingnow[index]['title'],
                    bannerurl:'https://image.tmdb.org/t/p/w500/'+playingnow[index]['backdrop_path'],
                    posterurl: 'https://image.tmdb.org/t/p/w500/'+playingnow[index]['poster_path'] ,
